...
namespace C3.CodeAnalysis.Net.Analyzer
{
    ...
    public class DateTimeMethodAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static string MessageFormat = $"Please consider using {DateTimeOffsetText} which provide better support for date/time on method parameters";
        ...
        private static DiagnosticDescriptor Rule = new
            DiagnosticDescriptor(CodeAnalysisConstants.DiagnosticIdDateTimeUseOnMethodOffset,
